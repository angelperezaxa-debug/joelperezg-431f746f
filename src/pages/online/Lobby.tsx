      ...
      <div className="w-full max-w-3xl flex flex-col gap-5">
        ...
        <header className="text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {salaName ? (
              <>
                {targetCount} taules disponibles
                <br />
                Toca un seient lliure per jugar
              </>
            ) : (
        ...
        {hasName && (
          <OnlinePlayersList
            ...
            myDeviceId={deviceId}
            title="Jugadors connectats a la sala"
        ...
        <p className="text-[10px] text-muted-foreground/70 text-center">
          {view.joinableCount + view.placeholderCount} taul{(view.joinableCount + view.placeholderCount) === 1 ? "a" : "es"} amb seients lliures
